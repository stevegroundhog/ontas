...
//#region node_modules/.nitro/vite/services/ssr/assets/defcon-osint-C5s4iHgO.js
var LABELS = {
	5: "FADE OUT",
	4: "DOUBLE TAKE",
	3: "ROUND HOUSE",
...
var fetchOsintDefcon_createServerFn_handler = createServerRpc({
	id: "7eccfaad6b10608de41dcc45dcf022373cfdb6e0a13c19d063d4f11943b772c0",
	name: "fetchOsintDefcon",
	filename: "src/server/defcon-osint.ts"
}, (opts) => fetchOsintDefcon.__executeServer(opts));
var fetchOsintDefcon = createServerFn({ method: "GET" }).handler(fetchOsintDefcon_createServerFn_handler, async () => {
	return getOsintDefcon();
});
//#endregion
export { fetchOsintDefcon_createServerFn_handler };
